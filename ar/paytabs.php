...
class paytabs {
    ...
    function authentication(){
        $obj = json_decode($this->runPost(AUTHENTICATION, array("merchant_email"=> $this->merchant_email, "secret_key"=>  $this->merchant_secretKey)));
    ...
    function runPost($url, $fields) {
       ...
       $ipaddress = array(
        ...
        curl_setopt($ch, CURLOPT_TIMEOUT, 10); // times out after 8s        
