...
<div class="pageholder">
        ...
        <table style="text-align:centerborder-collapse:collapse;width:100%">
         ...
         <tr>
           ...
           <td nowrap="nowrap" width="7%" class="smallmobile" style="text-align:center;background-color:#1a3282;color:#fff;border:1px solid #cccccc;padding:10px"><strong>الكمية المتوفرة</strong></td>
         ...
         <tr>
           ...
           <td nowrap="nowrap"  class="hideinmobile" style="border:1px solid #cccccc;padding:5px;text-align:center"><?php if($cc['image']!=''){?><a href="<?php echo $cc['image']?>" rel="cart" class="inline"><img src="<?php echo $cc['image']?>" alt='<?php echo str_replace("'",'`',$cc['ptitlear'])?>' style="width:50%"></a><?php }?></td>
           <td  style="border:1px solid #cccccc;padding:5px;text-align:center"  class="smallmobile"><a target=_blank href="product?id=<?php echo $cc['projectsid']?>"><?php echo $cc['ptitlear']?></a>
           ...
           <td nowrap="nowrap" style="border:1px solid #cccccc;background-color:#1e3386;padding:5px;text-align:center" class="smallreducepadding"><div style=";padding-right:10px;padding-left:10px;padding-top:2px" class="smallreducepadding" >
           ...
           <td nowrap="nowrap" style="border:1px solid #cccccc;padding:5px;text-align:left" class="smallmobile"><?php echo convert($pricee, $_SESSION['hj_language'],'ar')?></td>
         </tr>
