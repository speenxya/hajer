...
body {padding:20px;margin:0}
        ...
        <table width="100%" height="100%" cellpadding="0" cellspacing="0" align="center">
         <tr>
                ...
                while($sh=$con->fetch_array($shh)){?>
                      ...
                      <?php if($type=='after'){?>
                      <div style="text-align:center;margin-top:20px"><input type="submit" value="اعادة السلعة" /></div>
                      <?php }?>
                      <?php if($type=='before'){?>
                      <div style="text-align:center;margin-top:20px"><input type="submit" value="الغاء السلعة" /></div>
                      <?php }?>
                      </form>
                 <?php }?>
       ...
       function m_submit(){
        ...
        return confirm("يرجى  التأكد من اختيار سبب الارجاع الصحيح حتى لا يتم رفضه عند الفحص \n\  هل انت منأكد من أنك تريد اتمام عملية الإرجاع؟")
        <?php }?>
        <?php if($type=='before'){?>
