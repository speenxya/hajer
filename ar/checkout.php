...
<div class="pageholder">
       ...
       <?php if($total>0){?>   
        ...
        <div style="display:inline-block;margin-bottom:10px"> <input type="button" value="الرجوع" id="" onclick="window.location='address.php'" class="butt"  style="width:200px" /></div>
