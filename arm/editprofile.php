...
<div class="breadcrumbs">
		...
		<div id="pageContent">			
            ...
            <div class="row" style="margin:0;border:1px solid #cccccc;padding-top:20px;padding-bottom:20px">
                <h3 style="padding-right:10px">الملف الشخصي</h3>
                <div>
                <?php if($a_raw['alat']=='0'){
              ...
              <div style="">
                ...
                <div class="inputEntity"><label>الاسم الاول</label><input type="text" name="fname" id="fname" value="<?php echo $a_raw['fname']?>"></div>
                
                 <div class="inputEntity"><label>تاريخ الميلاد <span class="itsnotok">*</span></label><input type="text" name="dob" id="dob" value="<?php echo $a_raw['dob']?>" ></div>
              ...
              <div class="col-sm-6">
               <div>
                <div class="inputEntity"><label>اسم العائلة</label><input type="text" name="lname" id="lname" value="<?php echo $a_raw['lname']?>"></div>
                
                <div class="inputEntity"><label>بريد الالكتروني</label><input type="text" name="email" id="email" value="<?php echo $a_raw['email']?>" ></div>
              ...
              <div class="col-sm-6">
                 <div class="inputEntity"><label>كلمة السر</label><input type="password" name="apassword" id="apassword" value="<?php echo $a_raw['apassword']?>" ></div>
              </div>
              <div class="col-sm-6">
                <div class="inputEntity"><label>كلمة السر مرة اخرى</label><input type="password" name="apassword1" id="apassword1"></div>
              </div>
      ...
      if (bounds){
       map.fitBounds(bounds);
              ...
              <div class="col-sm-12">
               <div class="btnsHolder"><input class="btn btn-primary" type="submit" value="تحديث"></div>
              </div>
               ...
               <input class="btn btn-primary" type="button" value="اضافة عنوان " onClick="window.location='addresses.php'">
               <br /><br />
              </div>
               <div class="col-sm-12">
              <?php $phh=$con->query("select * from addresses left join access on accessid=idaccess where idaccess='".$_SESSION['hj_id']."'");
			   while($ph=$con->fetch_array($phh)){?>
                 <div><?php echo $ph['addressesname']?>
                  (<a href="addresses?code=<?php echo $ph['addressesid']?>">تصحيح</a> -  <a href="editprofile.php?deleteaddress=<?php echo $ph['addressesid']?>" onClick="return confirm('هل أنت متأكد من الحذف؟')">حذف</a>)</div>
               <?php }?>
              </div>
