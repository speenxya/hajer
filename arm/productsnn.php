...
<div class="breadcrumbs">
           ...
           <div class="container" style="margin-top:20px;margin-bottom:40px;">
					<div class="row">
						...
						while($br=$con->fetch_array($brr)){?>
							<div style=""><a class=" href="products?s=all&c=&min_price=&max_price=&orderby=&brand=<?php echo urlfriendlyi($br['brnamear'])?>">
        ...
        <?php }?>
         ...
         <input type="hidden" name="typee" value="<?php echo ($typee)?>">
							...
							<div class="collapse-block__content">
                                ...
                                <?php $gg=$con->query("select * from category where deleted='0' and bactive='Yes' and (bnamear!='New Arrivals') $catex  $extracategory order by bpriority asc,bnamear asc");
									...
									<li <?php if($c==$g['bnamear']){?>class="active open"<?php }?>>
										<a href="products?s=<?php echo urlfriendlyi($s)?>&c=<?php echo urlfriendlyi($g['bnamear'])?>&subcategory=&min_price=&max_price=&orderby=<?php echo $orderby?>&type=<?php echo $type?>&min_discount=<?php echo $min_discount?>&max_discount=<?php echo $max_discount?>&bestprice=<?php echo $bestprice?>&buygetfree=<?php echo $buygetfree?>&newarrival=<?php echo $newarrival?>&searchh=<?php echo $searchh?>"><?php echo $g['bnamear']?></a><span class="expander"></span>
										<ul>
										...
										while($gc=$con->fetch_array($ggc)){?>
                                            ...
                                            <a href="products?s=<?php echo urlfriendlyi($s)?>&c=<?php echo urlfriendlyi($g['bnamear'])?>&subcategory=<?php echo urlfriendlyi($gc['subcategorynamear'])?>&min_price=&max_price=&orderby=<?php echo $orderby?>&type=<?php echo $type?>&min_discount=<?php echo $min_discount?>&max_discount=<?php echo $max_discount?>&bestprice=<?php echo $bestprice?>&buygetfree=<?php echo $buygetfree?>&newarrival=<?php echo $newarrival?>&searchh=<?php echo $searchh?>"><?php echo $gc['subcategorynamear']?> (<?php echo $gc['countt']?>)</a></li>
                                            <?php }?>
										</ul>
									</li>
                                    <?php }?>
				...
				while($g=$con->fetch_array($gg)){?>
									  <li <?php if($brand==$g['brnamear']){?>class="active"<?php }?>><a class="ajaxx" href="<?php echo $_SERVER['PHP_SELF']?>?s=<?php echo urlfriendlyi($s)?>&c=<?php echo urlfriendlyi($c)?>&subcategory=<?php echo urlfriendlyi($subcategory)?>&min_price=<?php echo $min_price?>&max_price=<?php echo $max_price?>&orderby=<?php echo $orderby?>&brand=<?php echo urlfriendlyi($brand)?>|<?php echo urlfriendlyi($g['brnamear'])?>&type=<?php echo $type?>&min_discount=<?php echo $min_discount?>&max_discount=<?php echo $max_discount?>&bestprice=<?php echo $bestprice?>&buygetfree=<?php echo $buygetfree?>&newarrival=<?php echo $newarrival?>&searchh=<?php echo $searchh?>">
                                      <input class="thecheckbox" type="checkbox" <?php if (in_array($g['brnamear'], $brandcombine)) {?>checked="checked"<?php }?>\> <?php echo $g['brnamear']?> (<?php echo $g['countt']?>)
                                        </a></li>
                                    <?php }?>
								</ul>
							</div>
				...
				while($g=$con->fetch_array($gg)){?>
									  <li <?php if($material==$g['materialnamear']){?>class="active"<?php }?>><a class="ajaxx" href="<?php echo $_SERVER['PHP_SELF']?>?s=<?php echo urlfriendlyi($s)?>&c=<?php echo urlfriendlyi($c)?>&subcategory=<?php echo urlfriendlyi($subcategory)?>&min_price=<?php echo $min_price?>&max_price=<?php echo $max_price?>&orderby=<?php echo $orderby?>&brand=<?php echo $brand?>&type=<?php echo $type?>&min_discount=<?php echo $min_discount?>&max_discount=<?php echo $max_discount?>&bestprice=<?php echo $bestprice?>&buygetfree=<?php echo $buygetfree?>&newarrival=<?php echo $newarrival?>&feature=<?php echo urlfriendlyi($feature)?>&lastpiece=<?php echo $lastpiece?>&material=<?php echo urlfriendlyi($material)?>|<?php echo urlfriendlyi($g['materialnamear'])?>&typee=<?php echo urlfriendlyi($typee)?>&sizes=<?php echo urlfriendlyi($sizes)?>&colors=<?php echo urlfriendlyi($colors)?>&searchh=<?php echo $searchh?>">
                                      <input class="thecheckbox" type="checkbox" <?php if (in_array($g['materialnamear'], $materialcombine)) {?>checked="checked"<?php }?>\>  <?php echo $g['materialnamear']?> (<?php echo $g['countt']?>)
                                        </a></li>
                                    <?php }?>
								</ul>
							</div>
                        ...
                        if($con->num_rows($typeecheck)!=0){?>
							...
							<div class="collapse-block__content" style="<?php if($typee!=''){?>display:block<?php }?>">
                                ...
                                <?php $gg=$con->query("select *,count(*) as countt from projectstypee left join typee on typeeid=idtypee left join projects on idproject=projectsid left join supplier on supplierid=pidsupplier left join category on categoryid=idcategory left join subcategory on subcategoryid=idsubcategory left join brands on brandsid=idbrands where projects.deleted='0'  and typeeactive='Yes' $type_query and (prodactive='Yes' or prodactive='OOS') group by typeeid order by typeepriority asc,typeenamear asc");
				while($g=$con->fetch_array($gg)){?>
									  <li <?php if($typee==$g['typeenamear']){?>class="active"<?php }?>><a class="ajaxx" href="<?php echo $_SERVER['PHP_SELF']?>?s=<?php echo urlfriendlyi($s)?>&c=<?php echo urlfriendlyi($c)?>&subcategory=<?php echo urlfriendlyi($subcategory)?>&min_price=<?php echo $min_price?>&max_price=<?php echo $max_price?>&orderby=<?php echo $orderby?>&brand=<?php echo $brand?>&type=<?php echo $type?>&min_discount=<?php echo $min_discount?>&max_discount=<?php echo $max_discount?>&bestprice=<?php echo $bestprice?>&buygetfree=<?php echo $buygetfree?>&newarrival=<?php echo $newarrival?>&feature=<?php echo urlfriendlyi($feature)?>&lastpiece=<?php echo $lastpiece?>&material=<?php echo urlfriendlyi($material)?>&typee=<?php echo urlfriendlyi($typee)?>|<?php echo urlfriendlyi($g['typeenamear'])?>&sizes=<?php echo urlfriendlyi($sizes)?>&colors=<?php echo urlfriendlyi($colors)?>&searchh=<?php echo $searchh?>">
                                      <input class="thecheckbox" type="checkbox" <?php if (in_array($g['typeenamear'], $typeecombine)) {?>checked="checked"<?php }?>\>  <?php echo $g['typeenamear']?> (<?php echo $g['countt']?>)
                                        </a></li>
                                    <?php }?>
								</ul>
							</div>
				...
				while($g=$con->fetch_array($gg)){?>
									  <li <?php if($feature==$g['featuresnamear']){?>class="active"<?php }?>><a class="ajaxx" href="<?php echo $_SERVER['PHP_SELF']?>?s=<?php echo urlfriendlyi($s)?>&c=<?php echo urlfriendlyi($c)?>&subcategory=<?php echo urlfriendlyi($subcategory)?>&min_price=<?php echo $min_price?>&max_price=<?php echo $max_price?>&orderby=<?php echo $orderby?>&brand=<?php echo $brand?>&type=<?php echo $type?>&min_discount=<?php echo $min_discount?>&max_discount=<?php echo $max_discount?>&bestprice=<?php echo $bestprice?>&buygetfree=<?php echo $buygetfree?>&newarrival=<?php echo $newarrival?>&feature=<?php echo urlencode(urlfriendlyi($feature))?>|<?php echo urlencode(urlfriendlyi($g['featuresnamear']))?>&lastpiece=<?php echo $lastpiece?>&material=<?php echo urlfriendlyi($material)?>&typee=<?php echo urlfriendlyi($typee)?>&sizes=<?php echo urlfriendlyi($sizes)?>&colors=<?php echo urlfriendlyi($colors)?>&searchh=<?php echo $searchh?>">
                                       <input class="thecheckbox" type="checkbox" <?php if (in_array($g['featuresnamear'], $featurecombine)) {?>checked="checked"<?php }?>\> <?php echo $g['featuresnamear']?> (<?php echo $g['countt']?>)
                                        </a></li>
                                    <?php }?>
								</ul>
							</div>
				...
				while($g=$con->fetch_array($gg)){?>
									  <li <?php if($colors==$g['colornamear']){?>class="active"<?php }?>><a class="ajaxx" href="<?php echo $_SERVER['PHP_SELF']?>?s=<?php echo urlfriendlyi($s)?>&c=<?php echo urlfriendlyi($c)?>&subcategory=<?php echo urlfriendlyi($subcategory)?>&min_price=<?php echo $min_price?>&max_price=<?php echo $max_price?>&orderby=<?php echo $orderby?>&brand=<?php echo $brand?>&type=<?php echo $type?>&min_discount=<?php echo $min_discount?>&max_discount=<?php echo $max_discount?>&bestprice=<?php echo $bestprice?>&buygetfree=<?php echo $buygetfree?>&newarrival=<?php echo $newarrival?>&feature=<?php echo urlfriendlyi($feature)?>&lastpiece=<?php echo $lastpiece?>&material=<?php echo urlfriendlyi($material)?>&typee=<?php echo urlfriendlyi($typee)?>&sizes=<?php echo urlfriendlyi($sizes)?>&colors=<?php echo urlfriendlyi($colors)?>|<?php echo urlfriendlyi($g['colornamear'])?>&searchh=<?php echo $searchh?>">
                                      <input class="thecheckbox" type="checkbox" <?php if (in_array($g['colornamear'], $colorscombine)) {?>checked="checked"<?php }?>\>  <?php echo $g['colornamear']?> (<?php echo $g['countt']?>)
                                        </a></li>
                                    <?php }?>
								</ul>
							</div>
				...
				while($g=$con->fetch_array($gg)){?>
									  <li <?php if($sizes==$g['sizesnamear']){?>class="active"<?php }?>><a class="ajaxx" href="<?php echo $_SERVER['PHP_SELF']?>?s=<?php echo urlfriendlyi($s)?>&c=<?php echo urlfriendlyi($c)?>&subcategory=<?php echo urlfriendlyi($subcategory)?>&min_price=<?php echo $min_price?>&max_price=<?php echo $max_price?>&orderby=<?php echo $orderby?>&brand=<?php echo $brand?>&type=<?php echo $type?>&min_discount=<?php echo $min_discount?>&max_discount=<?php echo $max_discount?>&bestprice=<?php echo $bestprice?>&buygetfree=<?php echo $buygetfree?>&newarrival=<?php echo $newarrival?>&feature=<?php echo urlfriendlyi($feature)?>&lastpiece=<?php echo $lastpiece?>&material=<?php echo urlfriendlyi($material)?>&typee=<?php echo urlfriendlyi($typee)?>&sizes=<?php echo urlfriendlyi($sizes)?>|<?php echo urlfriendlyi($g['sizesnamear'])?>&colors=<?php echo urlfriendlyi($colors)?>&searchh=<?php echo $searchh?>">
                                      <input class="thecheckbox" type="checkbox" <?php if (in_array($g['sizesnamear'], $sizescombine)) {?>checked="checked"<?php }?>\> <?php echo $g['sizesnamear']?> (<?php echo $g['countt']?>)
                                        </a></li>
                                    <?php }?>
								</ul>
							</div>
