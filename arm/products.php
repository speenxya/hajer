...
<link rel="shortcut icon" href="favicon.ico">
		...
		<!-- Custom CSS -->
		<link rel="stylesheet" href="../css/style-layout11ar.css?v=5">
		<!-- Icon Fonts  -->
		<link rel="stylesheet" href="../font/style.css">
<link rel="stylesheet" href="../styles/fancybox.css">
<link type="text/css" href="../styles/notificationar.css" rel="stylesheet"  />
<style>
.filterholder {overflow-x:auto;white-space:nowrap;max-width:400px;padding-left:40px}
.filtercontent {margin-right:10px;border:1px solid #666666;text-align:center}
.collapse-block  {padding:0px}
.collapse-block__content {max-height:200px;overflow:auto;border:1px solid #cccccc;position:fixed;z-index:10000;background-color:#ffffff;padding:10px;bottom:0px;width:100%;left:0px}
.collapse-block__title:after {display:none}
.collapse-block__title {padding:10px;margin:0 auto;text-align:center}
...
<div class="pageholder" style="padding-top:92px!important">
		<!-- End HEADER section -->
		<!-- breadcrumbs -->
        ...
        <?php }?>
         ...
         <input type="hidden" name="typee" value="<?php echo ($typee)?>">
					...
					<aside class="col-md-8 col-lg-9 col-xl-10" id="centerColumn">
						...
						<!-- filters row -webkit-overflow-scrolling: touch -->
						<div class="filters-row border-top-none" style=";position:fixed;z-index:1000;background-color:#ffffff;padding:0px;margin:0px">
                        <div style="margin-top:30px;text-align:right;padding-right:10px;margin-bottom:20px"><a href="javascript:history.go(-1)">< الرجوع </a></div>
                            <div class="filterholder">
                               <div class="filtercontent" style="display:inline-block">
							...
							<div class="collapse-block__content" style="">
				...
				while($g=$con->fetch_array($gg)){?>
                        ...
                        <?php }?>                                
								...
								<div class="filters-row__mode" style="padding-left:20px">
								...
								<div class="filters-row__select" style="display:inline-block">
								<label>ترتيب حسب: </label>
									<div class="select-wrapper">
										<select name="orderby" onChange="window.location='<?php echo $_SERVER['PHP_SELF']?>?s=<?php echo urlfriendlyi($s)?>&c=<?php echo urlfriendlyi($c)?>&subcategory=<?php echo urlfriendlyi($subcategory)?>&min_price=<?php echo $min_price?>&max_price=<?php echo $max_price?>&orderby='+this.value+'&brand=<?php echo urlfriendlyi($brand)?>&type=<?php echo $type?>&min_discount=<?php echo $min_discount?>&max_discount=<?php echo $max_discount?>&bestprice=<?php echo $bestprice?>&buygetfree=<?php echo $buygetfree?>&newarrival=<?php echo $newarrival?>&feature=<?php echo urlfriendlyi($feature)?>&lastpiece=<?php echo $lastpiece?>&material=<?php echo urlfriendlyi($material)?>&typee=<?php echo urlfriendlyi($typee)?>&sizes=<?php echo urlfriendlyi($sizes)?>&colors=<?php echo urlfriendlyi($colors)?>&searchh=<?php echo $searchh?>'"  class="select--ys sort-position">
											<option value="name"  <?php if($orderby=='name'){?>selected='selected'<?php }?>>الفرز الافتراضى</option>
						...
						<div class="product-listing row" style="padding-top:175px">
						...
						//	echo $query;
												   ...
												   if($con->num_rowsfast($query)!=0){
													   ...
													   $passingparamssort="";
														$pager=new pagination($con->con,$query,$thispage,100,$passingparams."&".$passingparamssort);
            ...
            <?php }else{?>
            <div   class="col-sm-12" style="text-align:center;margin-top:100px;width:100%">لا توجد منتجات</div>
            <?php }?>
...
<script type="text/javascript" src="../js/notification.js"></script><script src="../js/functions.js"></script> <?php include "extrascripts.php"?>
        ...
        <script type="text/javascript">
         function closepopups(){
            ...
            $j('.collapse-block__content').hide()
                    return status
        }
        </script>
		<script>
			...
			$j(document).ready(function() {
				 ...
				 $j('.collapse-block').click(function(){
              $j('.collapse-block__content').hide()
              $j(this).find('.collapse-block__content').show()
             })
