                            ...
                            <input type="hidden" id="productsid<?php echo $countp?>" value="<?php echo $ress['projectsid']?>" />
								...
								<div class="product product--zoom">
									<div class="product__inside">
                                        ...
                                        <div style="margin-bottom:10px"><a style="color:red" href="wishlist?remove=<?php echo $ress['projectsid']?>" onClick="return confirm('هل أنت متأكد?')">إزالة من القائمة</a></div>
										<!-- /product review -->
