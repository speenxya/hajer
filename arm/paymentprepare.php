...
<div class="breadcrumbs">
		...
		<div id="pageContent">			
			...
			<!--  -->
			<div class="row">
            <div class="col-sm-12" style="text-align:center;margin-top:50px"><h3>المجموع: <?php echo convert($clientdetail['stotal'], $_SESSION['hj_language'],'ar')?></h3></div>
					<div class="col-md-12  col-sm-12 fieldholder">
                    <?php if(!isset($_REQUEST['resourcePath'])){?>
                       <form action="<?php echo $m_rooturl?>arm/processpayment.php" class="paymentWidgets"><?php echo $clientdetail['spaymethod']?>
                    ...
                    <div class="col-sm-12" style="text-align:center;margin-bottom:20px"><input type="button" class="butt" onClick="window.location='checkout'" value="الرجوع"></div>
                    <?php }?>
...
$j('.wpwl-control-surName').attr("placeholder","الإسم")
$j('.wpwl-control-givenName').attr("placeholder","إسم العائلة")
