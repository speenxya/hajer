			...
			<section class="content offset-top-0">
				<div class="container">
                    ...
                    <?php }?>
								...
								<div class="product-info col-sm-7">
									...
									<div class="product-info__title">
										<h1 style="margin-top:20px"><?php echo $data['ptitlear']?></h1>
									</div>
									...
									<div class="visible-xs">
										...
										<ul id="mobileGallery">
                                        <?php if($data['imageb']!=''){?>
											<li><a href="javascript:void()" data-image="../uploads/projects/<?php echo $data['imageb']?>" data-zoom-image="../uploads/projects/<?php echo $data['imageb']?>"><img src="../uploads/projects/<?php echo $data['imageb']?>" alt="" /></a></li>
                                            <?php }?>
                                        <?php if($data['imageb2']!=''){?>
											<li><a href="javascript:void()" data-image="../uploads/projects/<?php echo $data['imageb2']?>" data-zoom-image="../uploads/projects/<?php echo $data['imageb2']?>"><img src="../uploads/projects/<?php echo $data['imageb2']?>" alt="" /></a></li>
                                            <?php }?>
                                            <?php if($data['imageb3']!=''){?>
											<li><a href="javascript:void()" data-image="../uploads/projects/<?php echo $data['imageb3']?>" data-zoom-image="../uploads/projects/<?php echo $data['imageb3']?>"><img src="../uploads/projects/<?php echo $data['imageb3']?>" alt="" /></a></li>
                                            <?php }?>
                    ...
                    <?php }?>
									...
									<div class="price-box product-info__price"><?php echo convert($data['pspecialprice'], $_SESSION['hj_language'],'ar')?> <?php if($data['pspecialprice']!=$data['pprice']){?><span class="price-box__old"><?php echo convert($data['pprice'], $_SESSION['hj_language'],'ar')?> <span style="display:inline-block;font-size:12px;color:#fa6b6b;padding-right:20px">توفر <?php echo convert($data['pprice']-$data['pspecialprice'], $_SESSION['hj_language'],'ar')?> </span></span><?php }?></div>
