<div style="background-color: #1a3282;position:fixed;bottom:0px;width:100%;z-index:99;padding:5px" class="footerholder">
  ...
  <div style="float:left;width:20%;text-align: center">
   <a href="editprofile.php">
    ...
    <div style="color:#ffffff;font-size:9px" <?php if($pagetitle1=='meditprofile'){?>class="mactive"<?php }?>>ملفي الشخصي</div>
   </a> 
  </div>
  <div style="float:left;width:20%;text-align: center">
   <a href="orderhistory.php">
    ...
    <div style="color:#ffffff;font-size:9px" <?php if($pagetitle1=='morderhistory'){?>class="mactive"<?php }?>>طلباتي</div>
   </a> 
  </div>
  <div style="float:left;width:20%;text-align: center;position:relative">
   <a href="cart">
    ...
    <div style="color:#ffffff;font-size:9px" <?php if($pagetitle1=='mcart'){?>class="mactive"<?php }?>>سلة التسوق
    <span class="count cart-count" style="position:absolute;top:10px;left:10px;background-color:#000000;border-radius:50%;padding:1px 5px"><?php echo getcartcount()?></span></div>
   </a> 
  </div>
  <div style="float:left;width:20%;text-align: center">
   <a href="wishlist">
    <div><?php if($pagetitle1=='mwishlist'){?><img src="../images/b3m.png?v=1" style="width:80%;padding:0 10px"><?php }else{?><img class="footerhover" hover="../images/b3m.png" normal="../images/b3.png" src="../images/b3.png" style="width:80%;padding:0 10px"><?php }?></div>
    <div style="color:#ffffff;font-size:9px" <?php if($pagetitle1=='mwishlist'){?>class="mactive"<?php }?>>قائمة المفضلة</div>
   </a> 
  </div>
  
  <div style="float:left;width:20%;text-align: center">
   <a href="index">
    <div><?php if($pagetitle1=='mindex'){?><img src="../images/b5m.png?v=1" style="width:80%;padding:0 10px"><?php }else{?><img src="../images/b5.png" style="width:80%;padding:0 10px"><?php }?></div>
    <div style="color:#ffffff;font-size:9px" <?php if($pagetitle1=='mindex'){?>class="mactive"<?php }?>>الرئيسية</div>
   </a> 
  </div>
  </div>
</div>
