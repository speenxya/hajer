...
if(isset($_REQUEST['lat'])){
    $_SESSION['hajer_lat']=$_REQUEST['lat'];
    }
    if(isset($_REQUEST['long'])){
    $_SESSION['hajer_long']=$_REQUEST['long'];
    }
    //set langiage
...
<div class="hidden">
	 ...
	 while($hcaa=$con->fetch_array($hca)){?>					
					...
					<li>
						...
						<?php while($mobs=$con->fetch_array($mobss)){?>								
                    ...
                    <?php }?>
                     ...
                     <ul class="expander-list" style="display:none">	
                      <li>
                     <span class="name">
                            <a href="../enm/<?php echo basename($_SERVER['PHP_SELF'])?>?<?php echo $_SERVER['QUERY_STRING']?>"><span class="act-underline">English</span></a>
						</span>
                     </li>
                  ...
                  <div class="menuholder" style="background-color:#f6f6f9">حسابي</div>	  
                    <ul class="expander-list" style="display:none">	 
                      <?php if(isset($_SESSION['hj_id'])){?>
                       <li><span class="name"><a href="editprofile.php"><span class="act-underline">الملف الشخصي</span></a></span></li>	
                       <li><span class="name"><a href="wishlist.php"><span class="act-underline">قائمة امنياتي</span></a></span></li>	
                       <li><span class="name"><a href="orderhistory.php"><span class="act-underline">طلباتي</span></a></span></li>	
                       <li><span class="name"><a href="logout.php"><span class="act-underline">الخروج</span></a></span></li>	
             <?php }else{?>
                    <li><span class="name"><a href="signlog.php"><span class="act-underline">سجل / ادخل</span></a></span></li>	
                    <?php }?>
                    </ul>
                     ...
                     <li>
                     <span class="name">
							<a href="help"><span class="act-underline">المساعدة</span></a>
						</span>
                     </li>
                     </ul>
				...
				<div class="container">
					<div class="row mainrow">
						<div class="middleheader col-sm-2 smnopadding1024" style="padding-bottom:5px;text-align:center">
							<!-- logo start --> 
							<a href="#"><img class="logo img-responsive" src="../images/logoar.png" alt="<?php echo $titlar?>"/></a> 
							<!-- logo end --> 
						</div>
						...
						<div class="pull-left  col-sm-3 alignment-extra thetopone" >
                            ...
                            <a href="../enm/<?php echo basename($_SERVER['PHP_SELF'])?>?<?php echo $_SERVER['QUERY_STRING']?>" style="color:#ffffff;font-weight:16px;font-family:'ge_sslight'">English</a>  <span style="padding:0 5px">| </span>
                             <?php if(isset($_SESSION['hj_id'])){?>
                  ...
                  <option value="editprofile.php">الملف الشخصي</option>
                  <option value="wishlist.php">قائمة امنياتي</option>
                  <option value="orderhistory.php">طلباتي</option>
                  <option value="logout.php">الخروج</option>
                </select>
             <?php }else{?>
					<div style="display:inline-block;position:relative;z-index:10"  class="signholder"><a href="signlog.php" style="color:#ffffff">سجل / ادخل <img src="../images/menudownwhite.png"></a> 
                    <div class="signcontent" style="position:absolute;left:0px;width:200px;display:none;z-index:10">
                       <div style="text-align:center;background-color:#ffffff;border:1px solid #666666;color:#000000;padding:20px">
                        ...
                        <a class="butt" href="signlog.php" style="max-width:100px;margin:0 auto;display:block;background-color:#3a66dd;color:#ffffff;padding:10px 20px">الدخول</a>
                        
                        <hr style="border-top:1px solid #cccccc;margin:10px"/>
                        ليس لديك حساب؟ <br>
                        <a href="signlog.php" class="color2">سجل دخول</a>
                       </div>
                    </div>
                    </div>
								...
								<div class="cart link-inline thetopone">
									<div class="dropdown text-right shopping-cart ">
										<a class="dropdown-toggle " href="cart" rel="itsacart">
				...
				<div class="container">
					<div class="row">
                        ...
                        <div class="expand-nav compact-hidden">
							...
							<!-- logo start --> 
							<div class="tabletleft" style="float:right;width: 200px;padding-right: 30px;position: relative;top: -3px;"><a href="#"><img class="logo img-responsive" src="../images/logoar.png" alt="<?php echo $titlar?>"/></a> </div>
