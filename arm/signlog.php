		...
		<div id="pageContent">			
           ...
           <?php if(isset($msg2)){?>
              ...
              <div>
                ...
                <div class="btnsHolder" style=""><input class="btn btn-primary pageshower" style="width:100%" type="submit" value="الدخول"></div>
                <div><a href="forgot.php" class="btn btn-primary" style="width:100%;margin-top:5px" >نسيت كلمة المرور</a></div>
              </div>
