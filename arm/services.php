				...
				<ul class="expander-list">				
					...
					<li>
						...
						<ul class="dropdown-menu megamenu image-links" role="menu">							
							...
							<li class="col-one-fourth">
								<span class="image-link">
								<a href="listing-right-left-col.php">
								<span class="figure"><img class="img-responsive" src="../images/custom/listing-img-2.png" alt=""/></span>
								<span class="figcaption text-uppercase">right, left column</span>
								</a>
								</span>
							</li>
							<li class="col-one-fourth">
							...
							<li class="col-one-fourth">
								<span class="image-link">
								<a href="listing-col-right-without-without-static-block_05.php">
								<span class="figure"><img class="img-responsive" src="../images/custom/listing-img-5.png" alt=""/></span>
								<span class="figcaption text-uppercase">right column,<br> without Static block</span>
								</a>
								</span>
							</li>
							<li class="col-one-fourth">
			...
			<header id="header">
				...
				<div class="stuck-nav">
					<div class="container offset-top-5">
						<div class="row">
							<div class="pull-right col-sm-9 col-md-9 col-lg-10">
								<!-- navigation start -->
								<nav class="navbar">
									<div class="responsive-menu mainMenu">									
										...
										<ul class="nav navbar-nav">
											...
											<li class="dropdown dropdown-mega-menu">											
												<a href="index.php" class="dropdown-toggle" data-toggle="dropdown"><span class="act-underline">LAYOUT</span></a>
												<ul class="dropdown-menu megamenu image-links-layout" role="menu">												
													<li class="col-one-fourth">
														<span class="image-link">
														<a href="index.php">
											...
											<li class="dropdown dropdown-mega-menu">
												...
												<a href="listing.php" class="dropdown-toggle" data-toggle="dropdown"><span class="act-underline">LISTING</span></a>
												<ul class="dropdown-menu megamenu image-links" role="menu">
											...
											<li class="dropdown dropdown-mega-menu">
												<span class="dropdown-toggle extra-arrow"></span>
												<a href="product.php" class="dropdown-toggle" data-toggle="dropdown"><span class="act-underline">PRODUCT</span></a>
												<ul class="dropdown-menu megamenu image-links" role="menu">
													<li class="dl-back"><a href="#"><span class="icon icon-chevron_left"></span>back</a></li>
													<li class="col-one-third">
														<span class="image-link">
											...
											<li class="dropdown dropdown-mega-menu">
												<span class="dropdown-toggle extra-arrow"></span>
												<a href="blog-layout-1.php" class="dropdown-toggle" data-toggle="dropdown"><span class="act-underline">BLOG</span></a>
												<ul class="dropdown-menu megamenu image-links" role="menu">
													<li class="dl-back"><a href="#"><span class="icon icon-chevron_left"></span>back</a></li>
													<li class="col-one-third">
														<span class="image-link">
											...
											<li class="dropdown dropdown-mega-menu">
												<span class="dropdown-toggle extra-arrow"></span>
												<a href="gallery-layout-1.php" class="dropdown-toggle" data-toggle="dropdown"><span class="act-underline">GALLERY</span></a>
												<ul class="dropdown-menu megamenu image-links" role="menu">
													<li class="dl-back"><a href="#"><span class="icon icon-chevron_left"></span>back</a></li>
													<li class="col-one-fifth">
														<span class="image-link">
											...
											<li class="dropdown dropdown-mega-menu dropdown-two-col">
												<span class="dropdown-toggle extra-arrow"></span>
												<a href="about.php" class="dropdown-toggle" data-toggle="dropdown"><span class="act-underline">PAGES</span></a>
											...
											<li class="dropdown dropdown-mega-menu">
												<span class="dropdown-toggle extra-arrow"></span>
												<a href="listing.php" class="dropdown-toggle" data-toggle="dropdown"><span class="act-underline">WOMEN’s<span class="badge badge--menu">NEW</span></span></a>
												<ul class="dropdown-menu megamenu" role="menu">
													...
													<li class="col-sm-3">
														...
														<ul class="megamenu__submenu">
															...
															<li class="level2">
																<a href="listing.php">Dresses</a>
																<ul class="megamenu__submenu">
																	<li class="dl-back"><a href="#"><span class="icon icon-chevron_left"></span>back</a></li>
																	<li class="level3"><a href="listing.php">Bodycon Dresses</a></li>
																	<li class="level3">
																		<a href="listing.php">Midi Dresses</a>
																		<ul class="megamenu__submenu">
													...
													<li class="col-sm-3">
														<a href="listing.php" class="megamenu__subtitle"><span>BOTTOMS</span></a>
														<ul class="megamenu__submenu">
															<li class="dl-back"><a href="listing.php"><span class="icon icon-chevron_left"></span>back</a></li>
															<li class="level2"><a href="listing.php">Trousers</a></li>
															<li class="level2"><a href="listing.php">Jeans</a></li>
															<li class="level2"><a href="listing.php">Leggings</a></li>
															<li class="level2"><a href="listing.php">Jumpsuit & shorts</a></li>
															<li class="level2"><a href="listing.php">Skirts</a></li>
															<li class="level2"><a href="listing.php">Tights</a></li>
														</ul>
													</li>
													<li class="col-sm-3">
														<a href="listing.php" class="megamenu__subtitle"><span>ACCESSORIES</span></a>
														<ul class="megamenu__submenu">
															<li class="dl-back"><a href="listing.php"><span class="icon icon-chevron_left"></span>back</a></li>
															<li class="level2"><a href="listing.php">Jewellery</a></li>
															<li class="level2"><a href="listing.php">Hats</a></li>
															<li class="level2"><a href="listing.php">Scarves & snoods</a></li>
															<li class="level2"><a href="listing.php">Belts</a></li>
													...
													<li class="col-sm-3 hidden-xs">
														<a href="listing.php" class="megamenu__subtitle"><span>FEATURED</span></a>
														<!-- carousel -->
													...
													<li class="col-sm-3 hidden-xs">
														...
														<div class="vertical-carousel vertical-carousel-1 special-carousel">
															<div class="vertical-carousel__item">
																<div class="vertical-carousel__item__image pull-right"><a href="product.php"><img src="../images/product/product-120x150-1.jpg" alt=""></a></div>
															...
															<div class="vertical-carousel__item">
																<div class="vertical-carousel__item__image pull-right"><a href="product.php"><img src="../images/product/product-120x150-2.jpg" alt=""></a></div>
																<div class="product__label product__label--sale"> <span>Sale</span></div>
																<div class="vertical-carousel__item__title">
							...
							<!-- navigation end -->
							<div class="pull-left col-sm-3 col-md-3 col-lg-2">
									...
									<div class="account link-inline">
										<div class="dropdown text-right">
											...
											<ul class="dropdown-menu dropdown-menu--xs-full">
												...
												<li><a href="#"  data-toggle="modal" data-target="#modalالدخولForm"><span class="icon icon-lock"></span>Log In</a></li>
										...
										<div class="dropdown text-right">
											...
											<div class="dropdown-menu dropdown-menu--xs-full slide-from-top" role="menu">
												<div class="container">
													...
													<ul>
														<li class="cart__item">
															<div class="cart__item__image pull-right"><a href="#"><img src="../images/product/product-1.jpg" alt=""/></a></div>
															...
															<div class="cart__item__info">
																...
																<div class="cart__item__info__qty"><span class="info-label">الكمية:</span><input type="text" class="input--ys" value='1' /></div>
														...
														<li class="cart__item">
															<div class="cart__item__image pull-right"><a href="#"><img src="../images/product/product-2.jpg" alt=""/></a></div>
															<div class="cart__item__control">
																<div class="cart__item__delete"><a href="#" class="icon icon-delete"><span>Delete</span></a></div>
																<div class="cart__item__edit"><a href="#" class="icon icon-edit"><span>Edit</span></a></div>
															</div>
...
<div class="breadcrumbs">
			<div class="container">
				<ol class="breadcrumb breadcrumb--ys pull-right">
					...
					<li><a href="index.php">Women’s</a></li>						
		...
		<div id="pageContent">			
			<!-- parallax-img -->
			<section class="content--parallax content--parallax-sm offset-top-0" data-image="../images/custom/parallax-img-07.jpg">
	...
	dolore magna aliqua. Ut enim ad minim veniam, quis nostrud. </em>
				...
				<div class="container">					
					<div class="row">
						<div class="col-sm-12 col-md-6 col-sm-center">
							...
							<img src="../images/custom/image-bg-img-01.png" class="img-responsive" alt="">
						</div>
				...
				<div class="container">
					...
					<div class="row">
						<div class="col-md-3 col-sm-6 col-xs-6">
							<a class="link-img-hover1" href="#"><img src="../images/custom/img-content-01.jpg" class="img-responsive" alt=""></a>							
							<div class="divider divider--md1"></div>
							<p>
						...
						<div class="col-md-3 col-sm-6 col-xs-6">
							<a class="link-img-hover1" href="#"><img src="../images/custom/img-content-02.jpg" class="img-responsive" alt=""></a>
							<div class="divider divider--md1"></div>
							<p>
								<a class="hover-effect-01" href="#">
						...
						<div class="col-md-3 col-sm-6 col-xs-6">
							<a class="link-img-hover1" href="#"><img src="../images/custom/img-content-03.jpg" class="img-responsive" alt=""></a>
							<div class="divider divider--md1"></div>
							<p>
								<a class="hover-effect-01" href="#">
						...
						<div class="col-md-3 col-sm-6 col-xs-6">
							<a class="link-img-hover1" href="#"><img src="../images/custom/img-content-04.jpg" class="img-responsive" alt=""></a>
							<div class="divider divider--md1"></div>
							<p>
								<a class="hover-effect-01" href="#">
		...
		<footer>
			...
			<div class="container inset-bottom-60">
				<div class="row" >
					<div class="col-sm-12 col-md-5 col-lg-6 border-sep-left">
					...
					<div class="col-sm-12 col-md-7 col-lg-6 border-sep-right">
						<div class="row">
							<div class="col-sm-4">
								<div class="mobile-collapse">
									<h4 class="text-right  title-under  mobile-collapse__title">INFORMATION</h4>
							...
							<div class="col-sm-4">
								<div class="mobile-collapse">
									<h4 class="text-right  title-under  mobile-collapse__title">WHY BUY FROM US</h4>
									<div class="v-links-list mobile-collapse__content">
										<ul>
							...
							<div class="col-sm-4">
								<div class="mobile-collapse">
									<h4 class="text-right  title-under  mobile-collapse__title">MY ACCOUNT</h4>
									<div class="v-links-list mobile-collapse__content">
										<ul>
