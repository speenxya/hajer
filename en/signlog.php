...
<div class="pageholder">
		...
		<div id="pageContent">			
            ...
            <div class="row" style="margin-bottom:20px">
                 ...
                 <a href="facebook2/index?"><img src="../images/fbs.png" alt="facebook"></a>
                  <a href="google2/index?"><img src="../images/googles.png" alt="Google"></a>
                  <!--<a href="twitter2/index?connect=twitter"><img src="../images/twitters.png" alt="twitter"></a>-->
                 </div>
                </div>
           ...
           <?php if(isset($msg2)){?>
              ...
              <div>
                ...
                <div class="btnsHolder" style=""><input class="btn btn-primary" style="width:100%" type="submit" value="Login"></div>
                <div><a href="forgot.php" class="btn btn-primary iframe_supplierlogin" style="width:100%;margin-top:5px" >Forgot Password</a></div>
              </div>
