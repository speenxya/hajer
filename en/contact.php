...
if(@!sendmail($company_email,$contact_email, $titl." comments from  ".$email."",$body)) {
  $msg="<font class='itsnotok'>Error sending email, please try again later</font>";
	
} else {
  $msg="<font class='itsok'>Thanks for submitting the form, we will be in touch with you soon</font>";
			...
			<section class="container">				
				<div class="row">
					<div class="col-md-3 col-sm-12">
						...
						<ul class="list-icon" style='direction:ltr'>
                        <?php if($m_config['address']!=''){?>
							<li>
								<span class="icon icon-home"></span>
								<strong>Address :</strong> <?php echo $m_config['address']?>
							</li>
                          <?php }?>
                          <?php if($m_config['tel1']!=''){?>
							<li>
								<span class="icon icon-call"></span>
								<strong>Phone:</strong> <a style="color:#1b3383" href='tel:<?php echo $m_config['tel1']?>'><p style='display:inline' dir='ltr'><?php echo $m_config['tel1']?></p></a>
							</li>
                            <?php }?>
                          <?php if($m_config['tel2']!=''){?>
                            <li>
								<span class="icon icon-call"></span>
								<strong>Phone:</strong> <a style="color:#1b3383" href='tel:<?php echo $m_config['tel2']?>'><p style='display:inline' dir='ltr'><?php echo $m_config['tel2']?></p></a>
							</li>
                            <?php }?>
                          <?php if($m_config['fax']!=''){?>
							<li>
								<span class="fa fa-fax"></span>
								<strong>Fax:</strong> <?php echo $m_config['fax']?>
							</li>
                            <?php }?>
                          <?php if($m_config['ccontactemail']!=''){?>
							<li>
								<span class="icon icon-mail"></span>
								<strong>E-mail:</strong> <a class="color" href="mailto:<?php echo $m_config['ccontactemail']?>"><?php echo $m_config['ccontactemail']?></a>
							</li>
                            <?php }?>
						</ul>
					...
					<div class="col-md-9  col-sm-12">
                        ...
                        <input type="hidden" name="ismobile" value="<?php echo $ismobile?>" />
                           ...
                           <input class="btn btn--ys btn--xl btn-top" type="submit" value="Send Message">
						   <!-- /button -->						   
						</form>						
					</div>
				</div>					
