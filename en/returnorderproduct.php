...
$awbnumber =$clientdetail['awbnumber'];
        ...
        if($type=='before'){
            ...
            @sendmail($m_config['creturnemail'],$contact_email, $titl." - ".$subject."",$body);
...
body {padding:20px;margin:0}
        ...
        <table width="100%" height="100%" cellpadding="0" cellspacing="0" align="center">
         <tr>
                ...
                while($sh=$con->fetch_array($shh)){?>
                      ...
                      <?php if($type=='after'){?>
                      <div style="text-align:center;margin-top:20px"><input type="submit" value="Return Product" /></div>
                      <?php }?>
                      <?php if($type=='before'){?>
                      <div style="text-align:center;margin-top:20px"><input type="submit" value="Cancel Product" /></div>
                      <?php }?>
                      </form>
                      <?php }?>
       ...
       function m_submit(){
        ...
        return confirm("Please check the correct reason so that it does not get rejected during testing\n\
