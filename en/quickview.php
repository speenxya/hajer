		    	...
		    	<div class="product-popup">
                    ...
                    <?php $tempcount++;}?>
								...
								<div class="product-info col-sm-6 col-md-6 col-lg-6 col-xl-6" style="padding:20px">
									...
									<div class="price-box product-info__price"><?php echo convert($data['pspecialprice'], $_SESSION['hj_language'],'en')?> <?php if($data['pspecialprice']!=$data['pprice']){?><span class="price-box__old"><?php echo convert($data['pprice'], $_SESSION['hj_language'],'en')?> <span style="display:inline-block;font-size:15px;color:#fa6b6b;padding-left:20px">You save <?php echo convert($data['pprice']-$data['pspecialprice'], $_SESSION['hj_language'],'en')?> </span></span><?php }?></div>
                                    ...
                                    <a href="product?id=<?php echo $data['projectsid']?>" style="color:#1b3383" target=_parent>View Details</a>
                                    </div>
                                    </div>
