			...
			<section class="content offset-top-0">
				<div class="container">
                    ...
                    <?php }?>
								...
								<div class="product-info col-sm-7">
									...
									<div class="visible-xs">
                                        ...
                                        <?php if($data['imageb']!=''){?>
											<li><a href="#" data-image="../uploads/projects/<?php echo $data['imageb']?>" data-zoom-image="../uploads/projects/<?php echo $data['imageb']?>"><img style="width:100%" src="../uploads/projects/<?php echo $data['imageb']?>" alt="" /></a></li>
                                            <?php }?>
                                            <?php if($data['imageb2']!=''){?>
											<li><a href="#" data-image="../uploads/projects/<?php echo $data['imageb2']?>" data-zoom-image="../uploads/projects/<?php echo $data['imageb2']?>"><img style="width:100%" src="../uploads/projects/<?php echo $data['imageb2']?>" alt="" /></a></li>
                                            <?php }?>
                                            <?php if($data['imageb3']!=''){?>
											<li><a href="#" data-image="../uploads/projects/<?php echo $data['imageb3']?>" data-zoom-image="../uploads/projects/<?php echo $data['imageb3']?>"><img style="width:100%" src="../uploads/projects/<?php echo $data['imageb3']?>" alt="" /></a></li>
                                            <?php }?>
                    ...
                    <?php }?>
									...
									<div class="price-box product-info__price"><?php echo convert($data['pspecialprice'], $_SESSION['hj_language'],'en')?> <?php if($data['pspecialprice']!=$data['pprice']){?><span class="price-box__old"><?php echo convert($data['pprice'], $_SESSION['hj_language'],'en')?> <span style="display:inline-block;font-size:20px;color:#fa6b6b;padding-left:20px">You save <?php echo convert($data['pprice']-$data['pspecialprice'], $_SESSION['hj_language'],'en')?> </span></span> <?php }?></div>
