...
$redirector=m_fill("redirector",$_REQUEST);
	...
	if(!isset($suppliersa['accessid'])){
		$msg2="<font class='itsnotok'>Invalid username or password</font>";
                            ...
                            if($redirector!=''){
                                ?>
                                <script>
                                    window.location='<?php echo $redirector?>.php?userid=<?php echo $suppliersa['accessid']?>'
                                    </script>
						  <?php
                                }else{
						   ...
						   if(!$bas->get_cart()){  
						     // echo changelocation("index.php?userid=".$suppliersa['accessid']);
								//	exit();?>
                                <script>
                                    window.location='index.php?userid=<?php echo $suppliersa['accessid']?>'
                                    </script>
						  <?php  }else{
							//echo changelocation("address.php?userid=".$suppliersa['accessid']);
								//	exit();?>
                                    <script>
                                    window.location='address.php?userid=<?php echo $suppliersa['accessid']?>'
                                    </script>
						   <?php }
...
<div class="breadcrumbs">
		...
		<div id="pageContent">			
            ...
            <div class="row">
                ...
                <h3>New User</h3>
                 ...
                 <form enctype="multipart/form-data" name="form1" method="post" action="" onSubmit="return m_submit1()">
                        ...
                        <input type="hidden" name="redirector" value="<?php echo $redirector?>" />
                        
               <?php if(isset($msg1)){?>
                  <?php echo $msg1?>
               <?php }?>
              <div>
                <div class="inputEntity"><label for="email">Email Address</label><input type="text" name="email" id="email" ></div>
                
                <div class="btnsHolder"><input class="btn btn-primary" style="width:100%" type="submit" name="registerme" value="Register"></div>
              </div>
           ...
           <?php if(isset($msg2)){?>
               ...
               <?php }?>
              <div>
                <div class="inputEntity"><label for="ausername">Email</label><input type="text" name="ausername" id="ausername" ></div>
                <div class="inputEntity"><label for="apassword">Password</label><input type="password" name="apassword" id="apassword" style="width:95%;display:inline-block"> <a class="eye fa fa-eye" href="#"></a></div>
                
                <div class="btnsHolder" style=""><input class="btn btn-primary pageshower" style="width:100%" type="submit" value="Login"></div>
                <div><a href="forgot.php" class="btn btn-primary" style="width:100%;margin-top:5px" >Forgot Password</a></div>
              </div>
