...
<link rel="shortcut icon" href="favicon.ico">
		...
		<!-- Custom CSS -->
		<link rel="stylesheet" href="../css/style-layout11.css?v=5">
		<!-- Icon Fonts  -->
...
<style>
.filterholder {overflow-x:auto;white-space:nowrap;max-width:400px;padding-right:40px}
        ...
        <?php }?>
         ...
         <input type="hidden" name="typee" value="<?php echo ($typee)?>">
					...
					<aside class="col-md-8 col-lg-9 col-xl-10" id="centerColumn">
                        ...
                        <div style="margin-top:30px;text-align:left;padding-left:10px;margin-bottom:20px"><a href="javascript:history.go(-1)"> < Back </a></div>
							<div class="pull-left" >
							...
							<div class="collapse-block__content" style="">
                                ...
                                <?php $gg=$con->query("select * from category where deleted='0' and bactive='Yes' and (bname!='New Arrivals') $catex  $extracategory order by bpriority asc,bname asc");
									...
									<li <?php if($c==$g['bname']){?>class="active open"<?php }?>>
										<a href="<?php echo $_SERVER['PHP_SELF']?>?s=<?php echo urlfriendlyi($s)?>&c=<?php echo urlfriendlyi($g['bname'])?>&subcategory=&min_price=&max_price=&orderby=<?php echo $orderby?>&type=<?php echo $type?>&min_discount=<?php echo $min_discount?>&max_discount=<?php echo $max_discount?>&bestprice=<?php echo $bestprice?>&buygetfree=<?php echo $buygetfree?>&newarrival=<?php echo $newarrival?>&searchh=<?php echo $searchh?>"><?php echo $g['bname']?></a><span class="expander"></span>
										<ul>
										...
										while($gc=$con->fetch_array($ggc)){?>
                                            ...
                                            <a href="<?php echo $_SERVER['PHP_SELF']?>?s=<?php echo urlfriendlyi($s)?>&c=<?php echo urlfriendlyi($g['bname'])?>&subcategory=<?php echo urlfriendlyi($gc['subcategoryname'])?>&min_price=&max_price=&orderby=<?php echo $orderby?>&type=<?php echo $type?>&min_discount=<?php echo $min_discount?>&max_discount=<?php echo $max_discount?>&bestprice=<?php echo $bestprice?>&buygetfree=<?php echo $buygetfree?>&newarrival=<?php echo $newarrival?>&searchh=<?php echo $searchh?>"><?php echo $gc['subcategoryname']?></a> (<?php echo $gc['countt']?>)</li>
                                            <?php }?>
										</ul>
									</li>
                                    <?php }?>
				...
				while($g=$con->fetch_array($gg)){?>
									  <li <?php if($brand==$g['brname']){?>class="active"<?php }?>><a href="<?php echo $_SERVER['PHP_SELF']?>?s=<?php echo urlfriendlyi($s)?>&c=<?php echo urlfriendlyi($c)?>&subcategory=<?php echo urlfriendlyi($subcategory)?>&min_price=<?php echo $min_price?>&max_price=<?php echo $max_price?>&orderby=<?php echo $orderby?>&brand=<?php echo urlfriendlyi($g['brname'])?>&type=<?php echo $type?>&min_discount=<?php echo $min_discount?>&max_discount=<?php echo $max_discount?>&bestprice=<?php echo $bestprice?>&buygetfree=<?php echo $buygetfree?>&newarrival=<?php echo $newarrival?>&searchh=<?php echo $searchh?>"><?php echo $g['brname']?> (<?php echo $g['countt']?>)
                                        </a></li>
                                    <?php }?>
								</ul>
							</div>
				...
				while($g=$con->fetch_array($gg)){?>
									  <li <?php if($material==$g['materialname']){?>class="active"<?php }?>><a href="<?php echo $_SERVER['PHP_SELF']?>?s=<?php echo urlfriendlyi($s)?>&c=<?php echo urlfriendlyi($c)?>&subcategory=<?php echo urlfriendlyi($subcategory)?>&min_price=<?php echo $min_price?>&max_price=<?php echo $max_price?>&orderby=<?php echo $orderby?>&brand=<?php echo $brand?>&type=<?php echo $type?>&min_discount=<?php echo $min_discount?>&max_discount=<?php echo $max_discount?>&bestprice=<?php echo $bestprice?>&buygetfree=<?php echo $buygetfree?>&newarrival=<?php echo $newarrival?>&feature=<?php echo urlfriendlyi($feature)?>&lastpiece=<?php echo $lastpiece?>&material=<?php echo urlfriendlyi($g['materialname'])?>&typee=<?php echo urlfriendlyi($typee)?>&sizes=<?php echo urlfriendlyi($sizes)?>&colors=<?php echo urlfriendlyi($colors)?>&searchh=<?php echo $searchh?>"><?php echo $g['materialname']?> (<?php echo $g['countt']?>)
                                        </a></li>
                                    <?php }?>
								</ul>
							</div>
				...
				while($g=$con->fetch_array($gg)){?>
									  <li <?php if($typee==$g['typeename']){?>class="active"<?php }?>><a href="<?php echo $_SERVER['PHP_SELF']?>?s=<?php echo urlfriendlyi($s)?>&c=<?php echo urlfriendlyi($c)?>&subcategory=<?php echo urlfriendlyi($subcategory)?>&min_price=<?php echo $min_price?>&max_price=<?php echo $max_price?>&orderby=<?php echo $orderby?>&brand=<?php echo $brand?>&type=<?php echo $type?>&min_discount=<?php echo $min_discount?>&max_discount=<?php echo $max_discount?>&bestprice=<?php echo $bestprice?>&buygetfree=<?php echo $buygetfree?>&newarrival=<?php echo $newarrival?>&feature=<?php echo urlfriendlyi($feature)?>&lastpiece=<?php echo $lastpiece?>&material=<?php echo urlfriendlyi($material)?>&typee=<?php echo urlfriendlyi($g['typeename'])?>&sizes=<?php echo urlfriendlyi($sizes)?>&colors=<?php echo urlfriendlyi($colors)?>&searchh=<?php echo $searchh?>"><?php echo $g['typeename']?> (<?php echo $g['countt']?>)
                                        </a></li>
                                    <?php }?>
								</ul>
							</div>
				...
				while($g=$con->fetch_array($gg)){?>
									  <li <?php if($feature==$g['featuresname']){?>class="active"<?php }?>><a href="<?php echo $_SERVER['PHP_SELF']?>?s=<?php echo urlfriendlyi($s)?>&c=<?php echo urlfriendlyi($c)?>&subcategory=<?php echo urlfriendlyi($subcategory)?>&min_price=<?php echo $min_price?>&max_price=<?php echo $max_price?>&orderby=<?php echo $orderby?>&brand=<?php echo $brand?>&type=<?php echo $type?>&min_discount=<?php echo $min_discount?>&max_discount=<?php echo $max_discount?>&bestprice=<?php echo $bestprice?>&buygetfree=<?php echo $buygetfree?>&newarrival=<?php echo $newarrival?>&feature=<?php echo urlencode(urlfriendlyi($g['featuresname']))?>&lastpiece=<?php echo $lastpiece?>&material=<?php echo urlfriendlyi($material)?>&typee=<?php echo urlfriendlyi($typee)?>&sizes=<?php echo urlfriendlyi($sizes)?>&colors=<?php echo urlfriendlyi($colors)?>&searchh=<?php echo $searchh?>"><?php echo $g['featuresname']?> (<?php echo $g['countt']?>)
                                        </a></li>
                                    <?php }?>
								</ul>
							</div>
				...
				while($g=$con->fetch_array($gg)){?>
									  <li <?php if($colors==$g['colorname']){?>class="active"<?php }?>><a href="<?php echo $_SERVER['PHP_SELF']?>?s=<?php echo urlfriendlyi($s)?>&c=<?php echo urlfriendlyi($c)?>&subcategory=<?php echo urlfriendlyi($subcategory)?>&min_price=<?php echo $min_price?>&max_price=<?php echo $max_price?>&orderby=<?php echo $orderby?>&brand=<?php echo $brand?>&type=<?php echo $type?>&min_discount=<?php echo $min_discount?>&max_discount=<?php echo $max_discount?>&bestprice=<?php echo $bestprice?>&buygetfree=<?php echo $buygetfree?>&newarrival=<?php echo $newarrival?>&feature=<?php echo urlfriendlyi($feature)?>&lastpiece=<?php echo $lastpiece?>&material=<?php echo urlfriendlyi($material)?>&typee=<?php echo urlfriendlyi($typee)?>&sizes=<?php echo urlfriendlyi($sizes)?>&colors=<?php echo urlfriendlyi($g['colorname'])?>&searchh=<?php echo $searchh?>"><?php echo $g['colorname']?> (<?php echo $g['countt']?>)
                                        </a></li>
                                    <?php }?>
								</ul>
							</div>
				...
				while($g=$con->fetch_array($gg)){?>
									  <li <?php if($sizes==$g['sizesname']){?>class="active"<?php }?>><a href="<?php echo $_SERVER['PHP_SELF']?>?s=<?php echo urlfriendlyi($s)?>&c=<?php echo urlfriendlyi($c)?>&subcategory=<?php echo urlfriendlyi($subcategory)?>&min_price=<?php echo $min_price?>&max_price=<?php echo $max_price?>&orderby=<?php echo $orderby?>&brand=<?php echo $brand?>&type=<?php echo $type?>&min_discount=<?php echo $min_discount?>&max_discount=<?php echo $max_discount?>&bestprice=<?php echo $bestprice?>&buygetfree=<?php echo $buygetfree?>&newarrival=<?php echo $newarrival?>&feature=<?php echo urlfriendlyi($feature)?>&lastpiece=<?php echo $lastpiece?>&material=<?php echo urlfriendlyi($material)?>&typee=<?php echo urlfriendlyi($typee)?>&sizes=<?php echo urlfriendlyi($g['sizesname'])?>&colors=<?php echo urlfriendlyi($colors)?>&searchh=<?php echo $searchh?>"><?php echo $g['sizesname']?> (<?php echo $g['countt']?>)
                                        </a></li>
                                    <?php }?>
								</ul>
							</div>
                ...
                <?php }else{?>
           <div  class="col-sm-12" style="text-align:center;margin-top:100px;width:100%">No Products Found</div>
            <?php }?>
