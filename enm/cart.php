...
<div class="breadcrumbs">
        ...
        <table style="text-align:centerborder-collapse:collapse;width:100%">
         ...
         <tr>
           ...
           <td nowrap="nowrap"  class="hideinmobile" style="border:1px solid #cccccc;padding:5px;text-align:center;width:80px"><?php if($cc['image']!=''){?><a href="<?php echo $cc['image']?>" rel="cart" class="inline"><img src="<?php echo $cc['image']?>" alt='<?php echo str_replace("'",'`',$cc['ptitle'])?>' style="width:50%"></a><?php }?></td>
           <td  style="border:1px solid #cccccc;padding:5px;text-align:left"  class="smallmobile"><a target=_blank href="product?id=<?php echo $cc['projectsid']?>"><?php echo $cc['ptitle']?></a>
           ...
           <div  style="padding-bottom:10px;">Available: <?php echo $stockav?></div>
           ...
           <?php echo convert($pricee, $_SESSION['hj_language'],'en')?>
           </div></td>
