...
<link rel="shortcut icon" href="favicon.ico">
		...
		<!-- Custom CSS -->
		<link rel="stylesheet" href="../css/style-layout11.css?v=1">
		<!-- Icon Fonts  -->
...
<script src="../external/slick/slick.min.js?v=2"></script>
			...
			<section class="content offset-top-0">
				<div class="container">
                    ...
                    <?php }?>
								...
								<div class="product-info col-sm-7">
									...
									<div class="product-info__title">
										<h1 style="margin-top:20px"><?php echo $data['ptitle']?></h1>
									</div>
									...
									<div class="visible-xs">
                                        ...
                                        <?php if($data['imageb']!=''){?>
											<li><a href="javascript:void()" data-image="../uploads/projects/<?php echo $data['imageb']?>" data-zoom-image="../uploads/projects/<?php echo $data['imageb']?>"><img style="width:100%" src="../uploads/projects/<?php echo $data['imageb']?>" alt="" /></a></li>
                                            <?php }?>
                                            <?php if($data['imageb2']!=''){?>
											<li><a href="javascript:void()" data-image="../uploads/projects/<?php echo $data['imageb2']?>" data-zoom-image="../uploads/projects/<?php echo $data['imageb2']?>"><img style="width:100%" src="../uploads/projects/<?php echo $data['imageb2']?>" alt="" /></a></li>
                                            <?php }?>
                                            <?php if($data['imageb3']!=''){?>
											<li><a href="javascript:void()" data-image="../uploads/projects/<?php echo $data['imageb3']?>" data-zoom-image="../uploads/projects/<?php echo $data['imageb3']?>"><img style="width:100%" src="../uploads/projects/<?php echo $data['imageb3']?>" alt="" /></a></li>
                                            <?php }?>
                    ...
                    <?php }?>
									...
									<div class="price-box product-info__price"><?php echo convert($data['pspecialprice'], $_SESSION['hj_language'],'en')?> <?php if($data['pspecialprice']!=$data['pprice']){?><span class="price-box__old"><?php echo convert($data['pprice'], $_SESSION['hj_language'],'en')?> <span style="display:inline-block;font-size:12px;color:#fa6b6b;padding-left:20px">You save <?php echo convert($data['pprice']-$data['pspecialprice'], $_SESSION['hj_language'],'en')?> </span></span><?php }?></div>
							...
							<div class="content">
								...
								<div class="tab-content tab-content--ys nav-stacked">
                                    ...
                                    <div role="tabpanel" class="tab-pane" id="Tab3">
									     <div class="row">
                                         <?php if($data['pcode']!=''){?>
                                              <div class="col-sm-3 col-xs-6 pdesc">Product Code</div>
                                           ...
                                           <?php $gg=$con->query("select * from projectscolors left join colors on colorsid=idcolors where idproject='".$data['projectsid']."' ");
                                                                  ...
                                                                  while($g=$con->fetch_array($gg)){
                                                                    ...
                                                                    <?php if($thedat!=''){?>
                                              <div class="col-sm-3 col-xs-6 pdesc">Color</div>
                                              ...
                                              <?php if($thedat!=''){?>
                                              <div class="col-sm-3 col-xs-6 pdesc">Material</div>
                                              <div class="col-sm-3 col-xs-6 pdesc"><?php echo substr($thedat,0,-1)?></div>
                                              <?php }?>
                                               <?php if($data['plength']!=''){?>
                                              <div class="col-sm-3 col-xs-6 pdesc">Product Length</div>
                                              <div class="col-sm-3 col-xs-6 pdesc"><?php echo $data['plength']?> cm</div>
                                              <?php }?>
                                              <?php if($data['pheight']!=''){?>
                                              <div class="col-sm-3 col-xs-6 pdesc">Product Height</div>
                                              <div class="col-sm-3 col-xs-6 pdesc"><?php echo $data['pheight']?> cm</div>
                                              <?php }?>
                                              <?php if($data['pwidth']!=''){?>
                                              <div class="col-sm-3 col-xs-6 pdesc">Product Width/Depth</div>
                                              <div class="col-sm-3 col-xs-6 pdesc"><?php echo $data['pwidth']?> cm</div>
                                              <?php }?>
                                              <?php if($data['pcapacity']!=''){?>
                                              <div class="col-sm-3 col-xs-6 pdesc">Weight</div>
                                              <div class="col-sm-3 col-xs-6 pdesc"><?php echo $data['pcapacity']?></div>
                                              <?php }?>
                                              <?php if($data['ppower']!=''){?>
                                              <div class="col-sm-3 col-xs-6 pdesc">Power Consumption</div>
                                              <div class="col-sm-3 col-xs-6 pdesc"><?php echo $data['ppower']?> W</div>
                                              <?php }?>
                                              <?php if($data['pvoltage']!=''){?>
                                              <div class="col-sm-3 col-xs-6 pdesc">Voltage</div>
                                              <div class="col-sm-3 col-xs-6 pdesc"><?php echo $data['pvoltage']?> V</div>
                                              <?php }?>
                                              <?php if($data['penergy']!=''){?>
                                              <div class="col-sm-3 col-xs-6 pdesc">Energy Used</div>
                                              <div class="col-sm-3 col-xs-6 pdesc"><?php echo $data['penergy']?></div>
                                              <?php }?>
                                              <?php if($data['pfrequency']!=''){?>
                                              <div class="col-sm-3 col-xs-6 pdesc">Frequency</div>
                                              <div class="col-sm-3 col-xs-6 pdesc"><?php echo $data['pfrequency']?> Hz</div>
                                              <?php }?>
                                              <?php if($data['pspeed']!=''){?>
                                              <div class="col-sm-3 col-xs-6 pdesc">Speed</div>
                                              <div class="col-sm-3 col-xs-6 pdesc"><?php echo $data['pspeed']?> </div>
                                              <?php }?>
                                              <?php if($data['psizeml']!=''){?>
                                              <div class="col-sm-3 col-xs-6 pdesc">Size (ml)</div>
                                              <div class="col-sm-3 col-xs-6 pdesc"><?php echo $data['psizeml']?> </div>
                                              <?php }?>
                                               <?php if($data['psizegram']!=''){?>
                                              <div class="col-sm-3 col-xs-6 pdesc">Size (Gram)</div>
                                              <div class="col-sm-3 col-xs-6 pdesc"><?php echo $data['psizegram']?> </div>
                                              <?php }?>
                                               <?php if($data['psizeton']!=''){?>
                                              <div class="col-sm-3 col-xs-6 pdesc">Size (Ton)</div>
                                              <div class="col-sm-3 col-xs-6 pdesc"><?php echo $data['psizeton']?> </div>
                                              <?php }?>
                                               <?php if($data['psizegalon']!=''){?>
                                              <div class="col-sm-3 col-xs-6 pdesc">Size (Galon)</div>
                                              <div class="col-sm-3 col-xs-6 pdesc"><?php echo $data['psizegalon']?> </div>
                                              <?php }?>
                                               <?php if($data['ppieces']!=''){?>
                                              <div class="col-sm-3 col-xs-6 pdesc">No. of pieces</div>
                                              <div class="col-sm-3 col-xs-6 pdesc"><?php echo $data['ppieces']?> </div>
                                              <?php }?>
                                               <?php if($data['pheightmeter']!=''){?>
                                              <div class="col-sm-3 col-xs-6 pdesc">Height (meter)</div>
                                              <div class="col-sm-3 col-xs-6 pdesc"><?php echo $data['pheightmeter']?> </div>
                                              <?php }?>
                                               <?php if($data['pheightfeet']!=''){?>
                                              <div class="col-sm-3 col-xs-6 pdesc">Height (Feet)</div>
                                              <div class="col-sm-3 col-xs-6 pdesc"><?php echo $data['pheightfeet']?> </div>
                                              <?php }?>
                                               <?php if($data['pcapacitygalon']!=''){?>
                                              <div class="col-sm-3 col-xs-6 pdesc">Capacity (Galon)</div>
                                              <div class="col-sm-3 col-xs-6 pdesc"><?php echo $data['pcapacitygalon']?> </div>
                                              <?php }?>
                                               <?php if($data['pcapacityliter']!=''){?>
                                              <div class="col-sm-3 col-xs-6 pdesc">Capacity (Litre)</div>
                                              <div class="col-sm-3 col-xs-6 pdesc"><?php echo $data['pcapacityliter']?> </div>
                                              <?php }?>
                                               <?php if($data['pcapacitygram']!=''){?>
                                              <div class="col-sm-3 col-xs-6 pdesc">Capacity (Gram)</div>
                                              <div class="col-sm-3 col-xs-6 pdesc"><?php echo $data['pcapacitygram']?> </div>
                                              <?php }?>
                                               <?php if($data['pinsurance']!=''){?>
                                              <div class="col-sm-3 col-xs-6 pdesc">Warranty (Years)</div>
                                              <div class="col-sm-3 col-xs-6 pdesc"><?php echo $data['pinsurance']?> Year(s) </div>
                                              <?php }?>
                                              
                                               <?php if($data['pnotes']!=''){?>
                                              <div class="col-sm-3 col-xs-6 pdesc">Notes</div>
