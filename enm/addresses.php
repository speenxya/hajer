				...
				$a['addressesactive']="Yes";
				  ...
				  if(insert("addresses",$a,$con)){
				    ...
				    update("addresses",array("addressesid"=>$insertidd."-".$m_branch),"where dummy_addressesid='$insertidd'",$con);
					  ...
					  $msg="<font class='itsok'>Address has been successfully Saved</font>";
                      
                      echo changelocation("editprofile.php");
					  }
	  }else{
		  $msg=$duplicate;
	  }
	  ...
	  if($duplicate=='0'){
				...
				$a['addressesactive']="Yes";
				  ...
				  if(update("addresses",$a,"where addressesid='".m_prepare($code)."'",$con)){
					  $msg="<font class='itsok'>Address has been successfully updated</font>";
					  }
	  }else{
		  $msg=$duplicate;
	  }
...
<div class="breadcrumbs">
      ...
      if (bounds){
       map.fitBounds(bounds);
              ...
              <div>
              <div class="inputEntity"><label>Address name</label><input type="text" name="addressesname" id="addressesname" value="<?php echo $a_raw['addressesname']?>"></div>
              ...
              <div class="col-sm-12">
               <div class="btnsHolder"><input class="btn btn-primary" type="submit" value="Save"></div>
              </div>
