...
<div style="max-width:500px;margin:0 auto">
  <div style="float:left;width:20%;text-align: center">
   <a href="index" class="footeritem footerhover">
    ...
    <div style="color:#ffffff;font-size:11px" class="footerhover <?php if($pagetitle1=='mindex'){?>mactive<?php }?>">Home</div>
   </a> 
  </div>
...
if(!isset($_SESSION['hj_id'])){
   ...
   <a href="<?php echo $footerpage?>" class="footeritem footerhover">
    ...
    <div style="color:#ffffff;font-size:11px" class="footerhover <?php if($pagetitle1=='mwishlist'){?>mactive<?php }?>">Wishlist</div>
   </a> 
  </div>
   <div style="float:left;width:20%;text-align: center">
   <a href="cart" class="footeritem footerhover">
    ...
    <div style="color:#ffffff;font-size:11px" class=" footerhover<?php if($pagetitle1=='mcart'){?>mactive<?php }?>">Cart
...
if(!isset($_SESSION['hj_id'])){
   ...
   <a href="<?php echo $footerpage?>" class=" footeritem footerhover">
    ...
    <div style="color:#ffffff;font-size:11px" class=" footerhover<?php if($pagetitle1=='morderhistory'){?>mactive<?php }?>">My Orders</div>
   </a> 
  </div>
  <div style="float:left;width:20%;text-align: center">
  <?php 
...
if(!isset($_SESSION['hj_id'])){
   ...
   <a href="<?php echo $footerpage?>" class="footeritem footerhover">
    ...
    <div style="color:#ffffff;font-size:11px" class=" footerhover<?php if($pagetitle1=='meditprofile'){?>mactive<?php }?>">My Profile</div>
   </a> 
  </div>
  </div>
