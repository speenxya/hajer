...
$days= round($datediff / (60 * 60 * 24));
         ...
         <tr style='background-color:#dde2e6'>
           <td  style="WIDTH:100px;border:1px solid #cccccc;text-align:left"><?php if($hh['image']!=''){?><a href="<?php echo $hh['image']?>" rel="cart" class="inline"><img src="<?php echo $hh['image']?>" alt='<?php echo str_replace("'",'`',$hh['ptitle'])?>' style="width:50%"></a><?php }?></td>
           <td  style="padding-bottom:10px;border:1px solid #cccccc;text-align:left"><?php echo $hh['sname']?>
           <div>
           <a target=_blank href="product?id=<?php echo $hh['projectsid']?>"><?php echo $hh['ptitle']?></a>
           <?php if($hh['ocolor']!=''){?><div>Color: <?php echo $con->getcertainvalue("select * from colors where colorname='".$hh['ocolor']."'","colorname")?></div><?php }?>
           <?php if($hh['osize']!=''){?><div>Size: <?php echo $con->getcertainvalue("select * from sizes where sizesname='".$hh['osize']."'","sizesname")?></div><?php }?>
           </div>
           ...
           echo $returnstatus?>
            ...
            if($days<=15){?>
           <a class="butt" style="padding:2px 10px" href="returnorderproduct.php?id=<?php echo $hh['orderitemsid']?>&type=after">Return Request</a>
           <?php }else{?>
           This product cannot be returned , 15 days have passed</td>
           <?php }?>
           <?php }?>
           ...
           echo $returnstatus?>
                ...
                <?php }else{?>
           <a class="butt" style="padding:2px 10px" href="returnorderproduct.php?id=<?php echo $hh['orderitemsid']?>&type=before">Cancel Product</a>
           <?php }
           }else{?>
        ...
        <?php }?>
			...
			<div style="text-align:center;margin-top:20px"><a href="orderhistory.php">[Back]</a></div>
