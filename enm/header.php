	 ...
	 while($hcaa=$con->fetch_array($hca)){?>					
                    ...
                    <?php }?>
                     ...
                     <ul class="expander-list" style="display:none">	
                      <li>
                     <span class="name">
                            <a style="font-size:18px" href="../arm/<?php echo basename($_SERVER['PHP_SELF'])?>?<?php echo $_SERVER['QUERY_STRING']?>"><span class="act-underline">عربي</span></a>
						</span>
                     </li>
                  ...
                  <div class="menuholder" style="background-color:#f6f6f9">Account</div>	  
                    <ul class="expander-list" style="display:none">	 
                      <?php if(isset($_SESSION['hj_id'])){?>
                       <li><span class="name"><a href="editprofile.php"><span class="act-underline">Edit Profile</span></a></span></li>	
                       <li><span class="name"><a href="wishlist.php"><span class="act-underline">My Wishlist</span></a></span></li>	
                       <li><span class="name"><a href="orderhistory.php"><span class="act-underline">My Orders</span></a></span></li>	
                       <li><span class="name"><a href="logout.php"><span class="act-underline">Logout</span></a></span></li>	
             <?php }else{?>
                    <li><span class="name"><a href="signlog.php"><span class="act-underline">Sign in / Sign up</span></a></span></li>	
                    <?php }?>
                    </ul>
                     ...
                     <li>
                     <span class="name">
							<a href="help"><span class="act-underline">Help</span></a>
						</span>
                     </li>
                     </ul>
				...
				<div class="container">
					<div class="row mainrow">
						<div class="middleheader col-sm-2 smnopadding1024" style="padding-bottom:5px;text-align:center">
							<!-- logo start --> 
							<a href="#"><img class="logo img-responsive" src="../images/logo.png" alt="<?php echo $titl?>"/></a> 
							<!-- logo end --> 
						</div>
						...
						<div class="pull-right  col-sm-3 alignment-extra thetopone" >
                            ...
                            <a href="../arm/<?php echo basename($_SERVER['PHP_SELF'])?>?<?php echo $_SERVER['QUERY_STRING']?>" style="color:#ffffff;font-weight:16px;font-family:'ge_sslight'">العربية</a>  <span style="padding:0 5px">| </span>
                             <?php if(isset($_SESSION['hj_id'])){?>
                  ...
                  <option value="editprofile.php">Edit Profile</option>
                  <option value="wishlist.php">My Wishlist</option>
                  <option value="orderhistory.php">My Orders</option>
                  <option value="logout.php">Logout</option>
                </select>
             <?php }else{?>
					<div style="display:inline-block;position:relative;z-index:10"  class="signholder"><a href="signlog.php" style="color:#ffffff">Sign in / Sign up <img src="../images/menudownwhite.png"></a> 
                    <div class="signcontent" style="position:absolute;right:0px;width:200px;display:none;z-index:10">
                       <div style="text-align:center;background-color:#ffffff;border:1px solid #666666;color:#000000;padding:20px">
                        ...
                        <a class="butt" href="signlog.php" style="max-width:100px;margin:0 auto;display:block;background-color:#3a66dd;color:#ffffff;padding:10px 20px">Sign In</a>
                        
                        <hr style="border-top:1px solid #cccccc;margin:10px"/>
                        Don't have an Account? <br>
                        <a href="signlog.php" class="color2">Sign Up</a>
                       </div>
                    </div>
                    </div>
								...
								<div class="cart link-inline thetopone">
									<div class="dropdown text-right shopping-cart ">
										<a class="dropdown-toggle " rel="itsacart" href="cart">
				...
				<div class="container">
					<div class="row">
                        ...
                        <div class="expand-nav compact-hidden">
							...
							<!-- logo start --> 
							<div class="tabletleft" style="float:left;width: 200px;padding-left: 30px;position: relative;top: -3px;"><a href="#"><img class="logo img-responsive" src="../images/logo.png" alt="<?php echo $titl?>"/></a> </div>
							<!-- logo end --> 
						</div>
