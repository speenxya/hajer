...
$duplicate=0;
	 ...
	 // }
	  ...
	  if(trim($s_raw['spostalcode'])=='' || strlen($s_raw['spostalcode'])>$pclength || strpos($s_raw['spostalcode'], " ") !== false    || preg_match('/[a-z]/i', $s_raw['spostalcode'])){
		     $duplicate="<font class='itsnotok'>Postal Code is mandatory for delivery address (".$pc.")</font>";
	  }
      ...
      if(trim($s_raw['alat'])=='0' || trim($s_raw['alat'])==''){
		     $duplicate="<font class='itsnotok'>Please set your location on the map</font>";
	  }
     ...
     $shipping=getcostfixed($s_raw['scountry'],$s_raw['scity'],$s_raw['spostalcode']);
      ...
      if($shipping==0){
            $duplicate="<font class='itsnotok'>Shipping not found for your city</font>";
        }
      }
...
<link rel="shortcut icon" href="favicon.ico">
		...
		<!-- Custom CSS -->
		<link rel="stylesheet" href="../css/style-layout11.css?v=2">
		<!-- Icon Fonts  -->
...
<div class="breadcrumbs">
		...
		<div id="pageContent">			
            ...
            <div class="col-sm-6">
                ...
                <h3>My Addresses</h3>
                <div>
                  <select name="myaddress" id="myaddress" onChange="window.location='address.php?myaddress='+this.value">
                   <option value="Default">Primary Address</option>
               ...
               <?php }?>
                  </select> &nbsp;&nbsp;(<a href="editprofile.php" style="color:blue">Add Address</a>)
                </div>
                </div>
            </div>    
       ...
       map.fitBounds(bounds);
            ...
            <?php if(isset($msg1)){?>
              ...
              <div>
               ...
               <?php echo  dropdown(array('ownn'=>'0'),"countries","name","name","where deleted='0'","changecity1(this.value)","scountry",$data['country'],"","class='span12 selectt'")?></div>
               ...
               <!-- <div class="inputEntity"><label for="scountry">Country</label><?php //echo dropdown(array('ownn'=>'0'),"countries","name","name","","","scountry","","-","class='span12 selectt'")?>-->
                ...
                <div class="inputEntity"><label for="saddress">Shipping Company  <font class="itsnotok">*</font></label>
                ...
                <div style="direction:ltr">
                 ...
                 <?php }?>
                  <?php echo $sh['companylabel']?><br /><br />
                  </div>
                <?php }?>
                
                </div>
                <div class="inputEntity"><label for="saddress">Address  <font class="itsnotok">*</font></label><input type="text" name="saddress" id="saddress" maxlength="50" value="<?php echo $data['address']?>"  ></div>
                <div class="inputEntity"><label for="saddress">Postal code </label><input type="text" name="spostalcode" id="spostalcode" maxlength="50" value="<?php echo $data['postalcode']?>"  ></div>
                <!--<div class="inputEntity"><label for="stel">Tel</label></div>-->
                
                 <!--<div class="inputEntity"><label for="sfax">Fax</label></div>-->
                
                  <div class="inputEntity"><label for="smobile">Mobile  <font class="itsnotok">*</font></label><input type="text" maxlength="10" name="smobile" id="smobile" value="<?php echo $data['mobile']?>" placeholder="05xxxxxxxx" ></div>
                  <div class="inputEntity"><label for="sadditional">Comments & Preferred Delivery time</label><textarea type="text" name="sadditional" id="sadditional"><?php echo $data['additional']?></textarea></div>
              </div>
              </div>
              ...
              <div class="">
               ...
               <!-- <h3>Gift</h3><br>
                ...
                <input type="checkbox" name="termcheck" id="termcheck">  I agree to the Terms of Service and will adhere to them unconditionally. <a href="#readterms" class="inline">(Read Terms of Service)</a>
                <div id="readterms" style="display:none">
                  <div style="padding:10px">
                  <?php echo $alls['mprivacy']['field']?>
                  </div>
                </div>
                </div>
            ...
            <br><br>
                ...
                <div class="btnsHolder" style="text-align:left;float:left;width:30%"><input class="btn btn-primary" type="button" onClick="window.location='cart'" value="Back"></div>
                <div class="btnsHolder" style="text-align:right;float:right;width:30%"><input class="btn btn-primary" type="submit" value="Next"></div>
                <div style="clear:both">&nbsp;</div>
                </form>
	 ...
	 if (!$j("input[name='sshipping']:checked").val()) {
		  $j('#'+variabl).addClass("errorclass")
			  if(!$j('#'+variabl+'-error').length){
			   $j('#'+variabl).before("<div id='"+variabl+"-error' class='errorclass1'>Mandatory Field</div>")
			  }
			 $j('#'+variabl).focus()
			 return false
	}else{
