...
<form name="form2" method="post">
        ...
        <?php }else{?>
         <tr>
           <td colspan="5" style="text-align:center;color:#000000" nowrap>No Items Found
           <div style="padding-top:5px"><button class="butt" onclick="jQuery('.mshoppingcart_data').hide()">Close</button></div></td>
         </tr>
        <?php }?>
